                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(PickupActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(PickupActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
...
//        Log.e("Startloc",""+strDouble);
        ...
        if(meterInDec<200){
            ...
            intent.putExtras(bundle_edit);
            startActivity(intent);
            Toast.makeText(PickupActivity.this, "You are  in Center", Toast.LENGTH_SHORT).show();
        }
        else {

            Toast.makeText(PickupActivity.this, "You are not in Center", Toast.LENGTH_SHORT).show();
        }
