...
public class PickupActivityOnline extends AppCompatActivity implements View.OnClickListener{
...
//        officerId = (Button)findViewById(R.id.officerId);
        initToolBar();
        rvID = (RelativeLayout)findViewById(R.id.rvID);
...
//                break;
    ...
    private void showplanigfromdb(){
        //  Cursor cursor = helper.getawcsprocessInsert();+TABLE_FLAGGRECORD+ "=" +flaggrecord
        //  String query = "SELECT * FROM awcsprocess WHERE userid=" + userid;
        ...
        Log.e("SHOEE",userid+" "+" "+flaggrecord+" "+" "+flagg+" "+" "+flaggg);
...
//                                    project.setText("");
    ...
    public class PickupAdapterDatabase extends RecyclerView.Adapter<PickupAdapterDatabase.databaseViewHolder>{
        ...
        @Override
        public void onBindViewHolder(@NonNull final databaseViewHolder holder, int position) {
...
//                    startActivity(intent);
            ...
            holder.officerIdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String id = holder.tableID.getText().toString();
                    Intent intent = new Intent(getApplicationContext(), OfficerDetailsActivity.class);
                    Bundle bundle_edit  =   new Bundle();
                    bundle_edit.putString("id",id);
                    intent.putExtras(bundle_edit);
                    startActivity(intent);
                ...
                public void onClick(View v) {
                    ...
                    if (datee.equals(sysdate)) {
                        if (flag.equals("1")) {
                            ...
                            Toast.makeText(getApplicationContext(), "Please Edit First then Final submit", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
                        SQLiteDatabase sqldb = helper.getReadableDatabase();
        ...
        class databaseViewHolder extends RecyclerView.ViewHolder {
            TextView districId,projectId,sectorId,centerId,tableID,dateId,userID,
                    disID,proID,secID,CenID,flagID,latID,longID,awcsID,timeID,insID,rcflagId,processId,refresslatlangId;
            ...
            public databaseViewHolder(View itemView) {
                ...
                processId = itemView.findViewById(R.id.rcflagId);
    ...
    public class PickupAdapter extends RecyclerView.Adapter<PickupAdapter.OfflineViewHolder> {
        ...
        public void onBindViewHolder(final OfflineViewHolder holder, int position) {
            ...
            holder.procedIdd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent1 = new Intent(getApplicationContext(), ProcedActivity.class);
                    startActivity(intent1);
            ...
            holder.officerIdd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent1 = new Intent(getApplicationContext(), OfficerDetailsActivity.class);
                    startActivity(intent1);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(PickupActivityOnline.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(PickupActivityOnline.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    public float distance(float lat1, float lng1, float flat2, float flng2,String id,String distt,String project,String sector,
                          String center,String insid,String flagg,String dbdistid,
                          String dbprojectid,String dbsectorid,String dbcenterid,String awcscode,String flaggrecord) {
...
//        Log.e("Startloc",""+strDouble);
        ...
        if(meterInDec<200){
            ...
            intent.putExtras(bundle_edit);
            startActivity(intent);
            Toast.makeText(PickupActivityOnline.this, "You are  in Center", Toast.LENGTH_SHORT).show();
        }
        else {

            Toast.makeText(PickupActivityOnline.this, "You are not in Center", Toast.LENGTH_SHORT).show();
        }
