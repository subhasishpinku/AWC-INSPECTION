...
public class OfflineSyne extends Fragment  implements View.OnClickListener{
...
private Boolean mRequestingLocationUpdates;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.syne_offline, container, false);
...
public class PickupAdapterDatabase extends RecyclerView.Adapter<PickupAdapterDatabase.databaseViewHolder>{
    ...
    public PickupAdapterDatabase.databaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PickupAdapterDatabase.databaseViewHolder(view);
    }
...
public class PickupAdapter extends RecyclerView.Adapter<PickupAdapter.OfflineViewHolder> {
    ...
    @Override
    public PickupAdapter.OfflineViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pickuplistadapter, parent, false);
        return new PickupAdapter.OfflineViewHolder(view);
    }
    @Override
    public void onBindViewHolder(final PickupAdapter.OfflineViewHolder holder, int position) {
